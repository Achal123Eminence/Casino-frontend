...
@Component({
  ...
  imports: [FormsModule, MatSortModule, BsDatepickerModule, DateRangePickerComponent, CollapseHeaderComponent, MatSelectModule, MatIconModule, MatChipsModule, RouterLink, NgxEditorModule],
