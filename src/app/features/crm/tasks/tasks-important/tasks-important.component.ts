...
@Component({
  ...
  imports: [MatSelectModule, SelectModule, MatIconModule, MatChipsModule, RouterLink, CollapseHeaderComponent, BsDatepickerModule, TagInputModule, FormsModule, DateRangePickerComponent, CollapseHeaderComponent],
