...
@Component({
  ...
  imports: [RouterLink, NgxEditorModule, MatSelectModule, FormsModule, BsDatepickerModule, MatChipsModule, MatIconModule, CollapseHeaderComponent, ReactiveFormsModule, MatSortModule, SelectModule, TagInputModule],
