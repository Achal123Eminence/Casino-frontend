...
@Component({
  ...
  imports: [FormsModule, MatSortModule, CustomPaginationComponent, DateRangePickerComponent, CollapseHeaderComponent, MatSelectModule, RouterLink, TagInputModule, BsDatepickerModule],
