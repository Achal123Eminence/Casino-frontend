...
@Component({
  ...
  imports: [FormsModule, MatSortModule, CustomPaginationComponent, DateRangePickerComponent, CollapseHeaderComponent, MatSelectModule, SelectModule, MatIconModule, MatChipsModule, RouterLink, NgxEditorModule, BsDatepickerModule],
