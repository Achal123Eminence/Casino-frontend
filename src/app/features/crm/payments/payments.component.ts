...
@Component({
  ...
  imports: [FormsModule, RouterLink, CollapseHeaderComponent, MatSelectModule, MatIconModule, MatChipsModule, TagInputModule, NgxEditorModule, BsDatepickerModule, DateRangePickerComponent, CustomPaginationComponent, MatSort, MatSortModule, SelectModule],
