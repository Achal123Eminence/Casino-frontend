...
@Component({
    ...
    imports: [NgApexchartsModule, CollapseHeaderComponent, DateRangePickerComponent, RouterLink, BsDatepickerModule, SelectModule, FormsModule, MatSelectModule, MatChipsModule, MatIconModule]
})
