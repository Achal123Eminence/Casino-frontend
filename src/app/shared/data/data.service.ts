...
export class DataService {
  ...
  /**
   * getLanguageSettingsWeb function.
   * @returns {*} Result.
   */
  ...
  /**
   * getSuperAdminCompanies function.
   * @returns {*} Result.
   */
  ...
  /**
   * getMembershipTransactions function.
   * @returns {*} Result.
   */
  ...
  /**
   * getPurchaseTransaction function.
   * @returns {*} Result.
   */
  ...
  public sidebarData1: any[] = [
      ...
      menu: [
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Handle Permissions',
              base: 'handle-permission',
              route: routes.handlePermission,
              permissionKey: 'HANDLPERM',
            },
          ],
        },
        {
          menuValue: 'Default Form',
          hasSubRoute: true,
          showSubRoute: false,
          icon: 'user',
          base: 'default-form',
          permissionKey: 'DEFORM',
          subMenus: [
            {
              menuValue: 'Form Field List',
              base: 'form-fields',
              route: routes.formFields,
              permissionKey: 'FORFL',
            }
          ],
        },
        {
          menuValue: 'User Levels',
          icon: 'layout',
          route: routes.userLevels,
          base: 'user-levels',
          hasSubRoute: false,
          showSubRoute: false,
          permissionKey: 'LEVEL',
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Website Guide Creation',
              route: routes.websiteGuideCreation,
              hasSubRoute: false,
              showSubRoute: false,
              base: 'website-guide-creation',
    ...
    },
    {
      ...
      menu: [
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Management Users',
              route: routes.mgmtUsers,
              base: 'chat',
              hasSubRoute: false,
              showSubRoute: false,
            ...
            {
              menuValue: 'Administrative Users',
              route: routes.admnUsers,
              base: 'chat',
              hasSubRoute: false,
              showSubRoute: false,
              customSubmenuTwo: false,
...

    {
      ...
      menu: [
        ...
        {
          menuValue: 'Handle Permission',
          icon: 'handle-permission',
          route: routes.handlePermission,
          hasSubRoute: false,
          showSubRoute: false,
          base: 'handle-permission',
  ...
  public getManagementUser = (pageOption: any, params?: any) => {
    return this.http.get(`${environment.base_url}/user/list`, {
      params: {
        ...(params || {}),
        ...(pageOption || {}),
      },
   ...
   * @returns {*} Result.
   */
  public updateUserStatus(payload: updateUserStatusPayload): Observable<any> {
    return this.http.post(
      `${environment.base_url}/user/update-status`,
      payload
    );
  }

  /**
   * updateCreditReference function.
   * @param {*} payload - Parameter.
   * @returns {*} Result.
   */
  public updateCreditReference(
    payload: updateCreditReferencePayload
  ): Observable<any> {
    return this.http.post(
      `${environment.base_url}/user/update-credit-reference`,
      payload
    );
  }

  /**
   * updateBalanceForm function.
   * @param {*} payload - Parameter.
   * @returns {*} Result.
   */
  public updateBalanceForm(payload: updateBalancePayload): Observable<any> {
    return this.http.post(`${environment.base_url}/user/recharge`, payload);
  }

  /**
   * adminLogoutUser function.
   * Force logout a single user (admin action).
   * @param {*} userUuid - Parameter.
   * @returns {*} Result.
   */
  public adminLogoutUser(userUuid: string): Observable<any> {
    return this.http.post(
      `${environment.base_url}/auth/admin/logout-user`,
      { userUuid }
    );
  }

  /**
   * adminLogoutAllExceptSelf function.
   * Logout all users except the currently logged-in one.
   * @returns {*} Result.
   */
  public adminLogoutAllExceptSelf(): Observable<any> {
    return this.http.post(
      `${environment.base_url}/auth/admin/logout-all-except-self`,
      {}
    );
  }
   ...
   * @returns {*} Result.
   */
  public getFormFields = (params?: any) => {
    return this.http.get(`${environment.base_url}/form-fields/list`, {
      params,
    });
  };
  ...
  /**
   * hideOffCanvasModal function.
   * @param {*} canvasId - Parameter.
   * @returns {*} Result.
   */
  public hideOffCanvasModal(canvasId: string): void {
  ...
  /**
   * googleQrScanned function.
   * @param {*} payload - Parameter.
   * @returns {*} Result.
   */
  public googleQrScanned(
    payload: any
  ): Observable<any> {
    return this.http.post(
      `${environment.base_url}/auth/generate-qr`,
      payload
    );
  }
   ...
   * @returns {*} Result.
   */
  public googleAuthSetup( payload: googleAuthenticator): Observable<any> {
      return this.http.post(
        `${environment.base_url}/auth/qrcode-scann`,
        payload
      );
    }
