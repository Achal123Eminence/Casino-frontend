...
SideBarMouseHover=false;
  ...
  /**
   * changeSidebarColor function.
   * @param {*} sidebarColor - Parameter.
   * @returns {*} Result.
   */
  ...
  /**
   * changeTopbarHorizontalColor function.
   * @param {*} color - Parameter.
   * @returns {*} Result.
   */
